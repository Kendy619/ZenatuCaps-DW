...
DROP PROCEDURE SP_ETL_CLIENTE
DROP PROCEDURE SP_ETL_TIPO_VALOR
DROP PROCEDURE SP_ETL_PRODUTO
DROP PROCEDURE SP_ETL_FATO_PEDIDO
DROP PROCEDURE SP_ETL_FATO_ASSINATURA
DROP PROCEDURE ETL_TODOS_PROCEDURE



-- CLIENTE
GO
CREATE PROCEDURE SP_ETL_CLIENTE(@DATA DATETIME)
AS
BEGIN
	SET NOCOUNT ON
	DECLARE  
...
-- TIPO VALOR
GO
CREATE PROCEDURE SP_ETL_TIPO_VALOR(@DATA DATETIME)
AS
BEGIN
	SET NOCOUNT ON
	DECLARE  
...
-- PRODUTO
GO
CREATE PROCEDURE SP_ETL_PRODUTO(@DATA DATETIME)
AS
BEGIN
	SET NOCOUNT ON
	DECLARE  
...
-- PEDIDO
GO
CREATE PROCEDURE SP_ETL_FATO_PEDIDO(@DATA DATETIME)
AS
BEGIN
	DECLARE @DATA_PEDIDO DATETIME, 
	@ID_DATA_PREVISAO_CHEGADA BIGINT, 
	@ID_DATA_CHEGADA BIGINT, 
	@ID_DATA_COMPRA BIGINT, 
	@ID_OPERACIONAL INT, 
	@ID_PRODUTO INT, 
	@ID_TIPO_VALOR INT, 
	@ID_CLIENTE INT, 
	...
	DATA_COMPRA, DATA_PREVISAO_CHEGADA, DATA_CHEGADA
	FROM TB_AUX_PEDIDO
...
-- ASSINATURA
GO
CREATE PROCEDURE SP_ETL_FATO_ASSINATURA(@DATA DATETIME)
AS
BEGIN
	DECLARE @DATA_ASSINATURA DATETIME, 
	@ID_DATA_INICIO BIGINT, 
	@ID_DATA_CANCELAMENTO BIGINT, 
	@ID_OPERACIONAL INT, 
	@ID_CLIENTE INT, 
	@ID_TIPO_VALOR INT, 
	@STATUS VARCHAR(9),
	@MESES_ASSINATURA INT,
	@VALOR_MENSALIDADE NUMERIC(10,2)

	DECLARE C_FATO_ASSINATURA CURSOR FOR 
	SELECT DATACARGA, COD_ASSINATURA, VALOR_MENSALIDADE, STATUS, DATA_INICIO,
    DATA_CANCELAMENTO, ID_CLIENTE, ID_TIPO_VALOR
...
GO
CREATE PROCEDURE ETL_TODOS_PROCEDURE(@DATA DATETIME)
AS
BEGIN
	EXEC SP_ETL_PRODUTO '2023-01-01'
	EXEC SP_ETL_CLIENTE '2023-01-01'
	EXEC SP_ETL_TIPO_VALOR '2023-01-01'
	EXEC SP_ETL_FATO_PEDIDO '2023-01-01'
	EXEC SP_ETL_FATO_ASSINATURA '2023-01-01'
END

EXEC ETL_TODOS_PROCEDURE '2023-01-01'