...
DROP PROCEDURE SP_EXEC_ETL_TO_STAGGING
...
BEGIN
	...
	P.ID_ASSINATURA, P.DATA_COMPRA, P.PREVISAO_CHEGADA, P.DATA_CHEGADA, P.ID_ENCOMENDA FROM TB_PEDIDO P
		...
		BEGIN
			DECLARE C_PRODUTO_PEDIDO CURSOR FOR SELECT E.ID_PRODUTO FROM TB_PEDIDO PE INNER JOIN TB_ENCOMENDA E
...
CREATE PROCEDURE SP_EXEC_ETL_TO_STAGGING (@DATACARGA DATETIME)
AS
BEGIN
	EXEC SP_STAGGING_CLIENTE @DATACARGA
	EXEC SP_STAGGING_PRODUTO @DATACARGA
	EXEC SP_STAGGING_TIPO_VALOR @DATACARGA
	EXEC SP_STAGGING_ASSINATURA @DATACARGA
	EXEC SP_STAGGING_PEDIDO @DATACARGA
END


--EXECUTANDO TODOS OS PROCEDIMENTOS DE UMA VEZ
EXEC SP_EXEC_ETL_TO_STAGGING '20191010'